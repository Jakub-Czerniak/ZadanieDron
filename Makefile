...
main.out:  obj/main.o obj/MacierzOb.o obj/Macierz.o obj/Wektor.o obj/Dr3D_gnuplot_api.o obj/Obiekt3D.o obj/prostopadloscian.o obj/graniastoslup.o obj/sruba.o obj/dron.o obj/dno.o obj/powierzchnia.o obj/prst_przeszkoda.o
	g++ -o main.out obj/main.o obj/MacierzOb.o obj/Macierz.o obj/Wektor.o obj/Dr3D_gnuplot_api.o obj/Obiekt3D.o obj/prostopadloscian.o obj/graniastoslup.o obj/sruba.o obj/dron.o obj/dno.o obj/powierzchnia.o obj/prst_przeszkoda.o -lpthread

obj/main.o: src/main.cpp inc/Draw3D_api_interface.hh inc/Dr3D_gnuplot_api.hh inc/Wektor.hh inc/Macierz.hh inc/MacierzOb.hh inc/Obiekt3D.hh inc/prostopadloscian.hh inc/graniastoslup.hh inc/sruba.hh inc/dron.hh inc/dno.hh inc/powierzchnia.hh inc/InterfejsDrona.hh inc/przeszkoda.hh inc/prst_przeszkoda.hh 
...
obj/prostopadloscian.o: src/prostopadloscian.cpp inc/Macierz.hh inc/MacierzOb.hh inc/Wektor.hh inc/Dr3D_gnuplot_api.hh inc/Draw3D_api_interface.hh inc/prostopadloscian.hh inc/Obiekt3D.hh inc/InterfejsDrona.hh
...
obj/dron.o: src/dron.cpp inc/dron.hh inc/Macierz.hh inc/MacierzOb.hh inc/Wektor.hh inc/Dr3D_gnuplot_api.hh inc/Draw3D_api_interface.hh inc/prostopadloscian.hh inc/Obiekt3D.hh inc/graniastoslup.hh inc/sruba.hh inc/dno.hh inc/powierzchnia.hh inc/InterfejsDrona.hh inc/przeszkoda.hh 
	g++ ${CPPFLAGS} -o obj/dron.o src/dron.cpp

obj/dno.o: src/dno.cpp inc/dno.hh inc/Obiekt3D.hh inc/Wektor.hh inc/Dr3D_gnuplot_api.hh inc/Draw3D_api_interface.hh inc/dron.hh inc/InterfejsDrona.hh inc/przeszkoda.hh 
	g++ ${CPPFLAGS} -o obj/dno.o src/dno.cpp

obj/powierzchnia.o: src/powierzchnia.cpp inc/powierzchnia.hh inc/Obiekt3D.hh inc/Wektor.hh inc/Dr3D_gnuplot_api.hh inc/Draw3D_api_interface.hh inc/dron.hh inc/InterfejsDrona.hh inc/przeszkoda.hh 
	g++ ${CPPFLAGS} -o obj/powierzchnia.o src/powierzchnia.cpp	

obj/prst_przeszkoda.o: src/prst_przeszkoda.cpp inc/prst_przeszkoda.hh inc/prostopadloscian.hh inc/przeszkoda.hh inc/InterfejsDrona.hh inc/Wektor.hh 
	g++ ${CPPFLAGS} -o obj/prst_przeszkoda.o src/prst_przeszkoda.cpp

inc/przeszkoda.hh: inc/InterfejsDrona.hh
